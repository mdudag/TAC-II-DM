...
import { CorpoListas } from '../components/CorpoListas';
import { Rodape } from '../components/Rodape';
import { ModalAdicionarLista } from '../components/ModalAdicionarLista';
import { styles } from '../styles/styles';

export function ListasExercicios() {
  ...
  return (        
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.screen}>
        ...
        <Cabecalho titulo="Listas de Exercícios"
                   handlePressBotaoDir={handlePressAddLista}/>

        <ImageBackground source={require('../assets/fundo.png')}
                         resizeMode='cover'
                         style={styles.corpoFundo}>
          <CorpoListas sections={sections}
                       setPesq={setPesq}
